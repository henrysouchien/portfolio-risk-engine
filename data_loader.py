...
def fetch_monthly_treasury_rates(
    ...
    """
    from fmp.compat import fetch_monthly_treasury_rates as _compat_fetch_monthly_treasury_rates

    return _compat_fetch_monthly_treasury_rates(
        maturity,
        start_date,
        end_date,
    )
...
def fetch_dividend_history(
    ...
    *,
    ...
    """
    from fmp.compat import fetch_dividend_history as _compat_fetch_dividend_history

    return _compat_fetch_dividend_history(
        ticker,
        start_date,
        end_date,
        fmp_ticker=fmp_ticker,
