...
| N4 | Minor | 7× setState-during-render warnings | **FIXED** — `d455a9fd`. Scoped useDataSource subscription + memoized 5 components |
| N5 | Minor | Trading analysis 500 | **FIXED** — `861c24b0`. Graceful empty response for single-account |
