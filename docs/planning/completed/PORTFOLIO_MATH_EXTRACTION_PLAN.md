...
**Parent plan**: `docs/planning/AGENT_SURFACE_AUDIT.md` (Phase 2 scope)
**Predecessor**: `docs/planning/completed/RISK_CLIENT_TYPE_POLISH_PLAN.md` (Phase 1, SHIPPED)
**Status**: **SHIPPED 2026-04-17** — implemented across P2.1-P2.6 after Codex PASS v4
**Date**: 2026-04-17
...
| Commit | Summary |
|---|---|
| `a5230fed` | Scaffolded `portfolio_math`, dataclass types, and `GreeksSnapshot` migration. |
| `e59a86ae` | Extracted options pricing, Greeks, and implied-volatility math. |
| `5c4d6ff3` | Extracted correlation and risk-decomposition kernels. |
| `58f823a8` | Extracted stats and `compute_performance_metrics`. |
| `28c85d52` | Added README, version 0.1.0 metadata, changelog, and sandbox-mount TODO follow-up. |
