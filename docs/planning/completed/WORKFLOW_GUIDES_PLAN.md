...
> **Status**: DEFERRED — design concern about mixing workflow prompts into MCP tool layer. Revisit when the right abstraction level is clearer (separate MCP server? Claude Code skills? gateway-only?).
> **Created**: 2026-03-19
