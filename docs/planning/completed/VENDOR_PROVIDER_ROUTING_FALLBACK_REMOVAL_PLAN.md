...
**Sibling plans:** V1 plaid (`completed/VENDOR_PLAID_LOADER_SPLIT_PLAN.md`, shipped 2026-04-24) + V1 snaptrade (`completed/VENDOR_SNAPTRADE_LOADER_SPLIT_PLAN.md`, shipped 2026-04-25). V1b is the cleanup that surfaced from V1 plaid R1.
**Date:** 2026-04-25
**Status:** SHIPPED 2026-04-25 — dead fallback machinery deleted in `89acc99a`.

## Ship log

- 2026-04-25 — Plan filed in `d7d1e0ce`.
- 2026-04-25 — Implementation landed in `89acc99a`: removed the dead fallback machinery from `routes/provider_routing.py` while preserving the live status endpoint.
...
- V1 plaid plan: `docs/planning/completed/VENDOR_PLAID_LOADER_SPLIT_PLAN.md` (Codex R1 surfaced V1b)
- V1 snaptrade plan: `docs/planning/completed/VENDOR_SNAPTRADE_LOADER_SPLIT_PLAN.md`
...
- `docs/planning/completed/VENDOR_PLAID_LOADER_SPLIT_PLAN.md` (completed plan) — leave as historical record.
- `docs/planning/completed/VENDOR_PROVIDER_ROUTING_FALLBACK_REMOVAL_PLAN.md` (this plan) — expected.
