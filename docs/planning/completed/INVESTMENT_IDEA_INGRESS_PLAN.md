...
**Status**: **SHIPPED 2026-04-22** — R11 PASS plan preserved for historical reference.
**Created**: 2026-04-21
...
- `docs/planning/completed/THESIS_LIVING_ARTIFACT_PLAN.md` — plan #1 (PASS R7) for the Thesis bootstrap path
- `docs/planning/completed/HANDOFF_ARTIFACT_V1_1_PLAN.md` — plan #2 (PASS R5) for the `idea_provenance` acceptance surface
