...
**Status:** **SHIPPED 2026-04-23** — checkpoint preserved for historical reference.
**Snapshot:** 2026-04-23
...
| `dc2e9702` | E1+G1 | Phase 0 canary dataset locked (`docs/planning/completed/CORPUS_PHASE0_CANARY.md`) |
...
All 15 succeeded. Every `document_id` matches the locked accession in `docs/planning/completed/CORPUS_PHASE0_CANARY.md`. 10-Ks → 8 sections, 10-Qs → 6 sections, consistent across all three tickers.
...
| Canary dataset | `docs/planning/completed/CORPUS_PHASE0_CANARY.md` (locked 2026-04-23) |
| Checkpoint | `docs/planning/completed/CORPUS_PHASE0_CHECKPOINT.md` (this doc) |
