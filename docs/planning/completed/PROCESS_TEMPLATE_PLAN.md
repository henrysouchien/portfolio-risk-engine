...
**Status**: **SHIPPED 2026-04-23** — implementation plan preserved for historical reference.
...
Plan #5 was marked **SHIPPED** after merge and this plan was moved to `docs/planning/completed/`.
