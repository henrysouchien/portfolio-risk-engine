...
> Archived 2026-05-04 under `docs/planning/completed/` after end-to-end shipped status verification.
...
**Prior plans referenced**: `completed/PORTFOLIO_MATH_EXTRACTION_PLAN.md` (Phase 2 — base extraction), `completed/PORTFOLIO_MATH_OPTIONS_PAYOFF_EXTRACTION_PLAN.md` + `completed/PORTFOLIO_MATH_OPTIONS_ROOT_EXPORT_FIX_PLAN.md` (Phase 3D — pattern match).
...
After Steps 1-5 ship in risk_module, on a separate AI-excel-addin PR (mirroring `completed/PORTFOLIO_MATH_OPTIONS_AI_EXCEL_ADDIN_PLAN.md` Steps 6-7):
