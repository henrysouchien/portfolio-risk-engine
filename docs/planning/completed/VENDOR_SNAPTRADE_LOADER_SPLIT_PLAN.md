...
**Sibling plan:** `docs/planning/completed/VENDOR_PLAID_LOADER_SPLIT_PLAN.md` (same pattern, plaid slice)
**Predecessor:** main vendor SDK boundary refactor (PR #7, merged `3dbc0774`, 2026-04-23)
**Date:** 2026-04-24
**Status:** SHIPPED 2026-04-25 — services extraction landed in `a45eba7e`; V1c API-surface cleanup remains deferred.

## Ship log

- 2026-04-25 — Implementation landed in `a45eba7e`: moved SnapTrade business logic into `services/snaptrade_*`, deleted the loader, dropped brokerage init lazy wrappers, updated callers/tests/docs, and transferred the boundary-internal allowlist.
- Deferred V1c remains the public retry-wrapper cleanup noted in §4.4.
