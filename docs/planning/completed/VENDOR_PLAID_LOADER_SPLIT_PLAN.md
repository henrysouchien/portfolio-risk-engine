...
**Sibling plan:** `docs/planning/completed/IBKR_CONTRACT_SPEC_BOUNDARY_PLAN.md` (V5, shipped 2026-04-24) established the pattern
**Date:** 2026-04-24
**Status:** SHIPPED 2026-04-24 — services extraction landed in `c5d417c5`; V1b fallback cleanup tracked separately.

## Ship log

- 2026-04-24 — Plan approved as Codex PASS R4 in `d23b93ee`.
- 2026-04-24 — Implementation landed in `c5d417c5`: moved Plaid business logic into `services/plaid_*`, deleted the loader, updated callers, and removed lint boundary entries.
- Follow-up V1b was filed for dead provider-routing fallback cleanup and later handled in `89acc99a`.
