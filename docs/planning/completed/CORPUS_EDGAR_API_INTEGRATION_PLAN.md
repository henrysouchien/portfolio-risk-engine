> **✅ SHIPPED — closed 2026-05-08 (plan reflects shipped upstream Edgar `/api/filing/document` fix; see `docs/TODO_COMPLETED.md`). Moved from `docs/planning/` during 2026-05-26 docs cleanup.**
