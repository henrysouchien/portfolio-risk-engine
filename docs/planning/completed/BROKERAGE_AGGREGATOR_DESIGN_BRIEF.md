> **✅ SHIPPED — aggregator pattern live: brokerage-connect package + services/position_snapshot_cache.py + webhook-driven sync workers. Moved during 2026-05-26 docs cleanup.**
