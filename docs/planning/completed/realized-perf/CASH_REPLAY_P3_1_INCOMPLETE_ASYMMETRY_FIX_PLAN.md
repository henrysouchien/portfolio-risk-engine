...
> **SUPERSEDED (2026-02-26):** This plan is superseded by `CASH_REPLAY_P5_VSTART_SEEDING_PLAN.md`, which implements budget-based quantity suppression for incomplete trade cash (more precise than the mode switch proposed here). The position timeline fix for futures incomplete trades was implemented separately via `CASH_REPLAY_P4_INCOMPLETE_TRADE_FIX_PLAN.md`. Do not implement this plan.
