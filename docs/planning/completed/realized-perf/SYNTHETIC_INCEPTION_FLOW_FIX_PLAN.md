...
**Status**: REVERTED (attempted 2026-03-01). IBKR barely moved (-0.07pp), Plaid regressed 14pp. Flow injection seeds Modified Dietz denominator but doesn't fix V_start=0 → large NAV jump. Price priority flip had unintended side-effects on all sources. See `docs/planning/performance-actual-2025/RETURN_PROGRESSION_BY_FIX.md`.
