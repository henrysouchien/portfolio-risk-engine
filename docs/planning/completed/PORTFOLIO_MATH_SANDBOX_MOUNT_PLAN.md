...
**Parent plan**: `docs/planning/AGENT_SURFACE_AUDIT.md` (post-Phase-2 follow-up)
**Predecessor**: `docs/planning/completed/PORTFOLIO_MATH_EXTRACTION_PLAN.md` (Phase 2, SHIPPED)
