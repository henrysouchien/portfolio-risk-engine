# Archived Planning TODO Reference

**STATUS:** ARCHIVED on 2026-03-19
**Canonical TODO**: [`docs/TODO.md`](../../TODO.md) — single source of truth for all work items.

This file preserves the old planning-side handoff notes after the duplicate `TODO.md` was retired from `docs/planning/`. For active work, use `docs/TODO.md` plus the linked plan docs.

---

## Active Handoff Context

These are the current workstreams that merit implementation-level context. When a workstream is no longer active, collapse it into a shorter archive note below.

| Workstream | Primary docs | Implementation note |
|------------|--------------|---------------------|
| Phase 5A — Design audit cleanup | `DESIGN_AUDIT_2026-03-19.md` | Remaining findings are UI polish only: touch targets, alert banner dominance, heading hierarchy |
| Phase 5B — Realized performance accuracy | `../PER_SYMBOL_INCEPTION_PLAN.md`, `../SYNTHETIC_INCEPTION_FLOW_FIX_PLAN.md`, `../SYNTHETIC_TWR_FLOW_FIX_PLAN.md`, `../TWR_TINY_BASE_DEFERRAL_PLAN.md`, `../CASH_REPLAY_P5_VSTART_SEEDING_PLAN.md` | Execute sequentially; start with per-symbol inception before synthetic flow or TWR work |
| Active bug — combined benchmark line gap | `../../TODO.md`, `../PERFORMANCE_BASELINE_2026-03-19.md` | Frontend chart is believed correct; investigate why combined portfolios return empty `benchmark_returns` |
| Phase 5C — Backend perf final validation | `../BACKEND_PERF_OPTIMIZATION_PLAN.md`, `../PERFORMANCE_BASELINE_2026-03-19.md` | Only Phase 6 re-measure remains; use the latest baseline doc for comparison |
| Phase 6 — Deploy and verify | `FINAL_DEPLOY_VERIFY_PLAN.md`, `../../deployment/MULTI_USER_DEPLOYMENT_PLAN.md`, `AGENT_CODE_EXECUTION_REGISTRY_PLAN.md` | Infra execution is blocked by domain availability and low disk headroom before EBS expansion |

## Brokerage Statement Import — Filesystem Transaction Store — DONE

**Plans**: `transactions/BROKERAGE_STATEMENT_IMPORT_PLAN.md`
...
Plan: `infrastructure/MULTI_USER_AUDIT_FIX_PLAN.md`. Commit `5027a351`.
...
Plan: `../../deployment/MULTI_USER_DEPLOYMENT_PLAN.md`. Commits `15138d6e`, `eb8fd989`.
