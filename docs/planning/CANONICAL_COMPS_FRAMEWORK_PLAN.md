...
- `docs/planning/INVESTMENT_SCHEMA_UNIFICATION_PLAN.md` §6.2 (`industry_analysis` shared-slice on `HandoffArtifact v1.1`), §6.6 (Thesis shared-slice), §10b.1 (industry-research sourcing — answered "skill, not tool" for narrative parts; this doc covers structured comps).
