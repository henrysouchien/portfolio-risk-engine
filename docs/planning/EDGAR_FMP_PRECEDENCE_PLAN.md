...
**Status**: DRAFT R5 — addresses Codex R4 "very close to PASS" (1 residual blocker, 3 should-fix)
**Created**: 2026-04-27
**Closes**: G8 from `docs/planning/INVESTMENT_SCHEMA_UNIFICATION_PLAN.md`
**Depends on**:
- ModelBuildContext (SHIPPED) — `MODEL_BUILD_CONTEXT_PLAN.md`
- HandoffArtifact v1.1 (SHIPPED) — `HANDOFF_ARTIFACT_V1_1_PLAN.md`
