...
## Status: v5 — PROPOSED (2026-04-30; v1-v4 same day. Codex reviews of v2/v3/v4 all returned FAIL with progressively narrower scope. v5 addresses the 2 v4-FAIL required changes). Decision locked: **Option 1**. Concrete step sequence in §Implementation.
