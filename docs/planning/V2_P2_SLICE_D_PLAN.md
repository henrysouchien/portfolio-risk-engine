...
**Status:** DRAFT R8 — Codex R8 returned CONDITIONAL PASS; this revision applies the single doc-consistency fix (bootstrap/hydrate bullets) + workspace-switch lifecycle clarification. Pending Codex R9 to confirm PASS.
